...
public class ewenokx {
	...
	{
		GameRegistry.addRecipe(new ItemStack(items.iron_stick), "#", "#", '#', Items.iron_ingot);
		GameRegistry.addRecipe(new ItemStack(items.orichalque_ingot, 9), "#", '#', blocks.orichalque_block);
		GameRegistry.addRecipe(new ItemStack(blocks.orichalque_block), new Object[] {"###", "###", "###", '#', items.orichalque_ingot});
		GameRegistry.addSmelting(blocks.orichalque_ore, new ItemStack(items.orichalque_ingot), 1.0F);
